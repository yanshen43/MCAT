...
sys.path.append('/home/ugrads/nonmajors/jrm98/meme/lib/python')
import alphabet
import sequence
...
def estimate_new_hamming_counts(word, alph, counts, freqs, nsites):
    ...
    for col in xrange(w):
        ...
        # new letter index
        for symi in xrange(alph.getFullLen()):
