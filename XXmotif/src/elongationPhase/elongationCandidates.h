...
private:
	...
	/* out dated functions */
	//void countAllOccurrences_oops(uint8_t gapIndex, uint32_t *occIUPAC, uint32_t *countIUPAC);
	//void countIUPAC_oops_rec(uint32_t* occIUPAC, uint32_t* countIUPAC, uint32_t id, int seq, int pos, int depth);
