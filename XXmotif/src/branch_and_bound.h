...
private:
	...
	//void setLeftConsKmer();
	//std::unordered_map<UngappedKmer, std::shared_ptr<prefix_list_t> > prefixLists;
  	//void expandPrefixes(std::shared_ptr<prefix_list_t> kmers, const int firstIndex);
	//void generatePrefixes();
	//void calculateRightProbabilities();
